...
pub use event_log::{
    ...
    record_scheduled_step, record_task_assigned, record_task_created, record_worker_failure,
    record_worker_recovery, EventEnvelope, EventKind, EventLog, ExecutionError,
...
pub use scenario::{
    ...
    run_scheduled_mining, run_worker_failure_recovery, validate_mining_bootstrap_final_state,
    validate_policy_gate_final_state, validate_scheduled_mining_final_state,
    validate_worker_failure_recovery_final_state, ScenarioError, ScenarioRun,
};
